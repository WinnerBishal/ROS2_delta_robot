...
bool delta_interfaces__msg__detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("delta_interfaces.msg._detection.Detection", full_classname_dest, 41) == 0);
  }
  delta_interfaces__msg__Detection * ros_message = _ros_message;
  {  // x
...
PyObject * delta_interfaces__msg__detection__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("delta_interfaces.msg._detection");
